...
# Conclusion
In the model evaluation, the evaluation metric results show that the *XGBRegressor* model provides the best results, with an *RMSE* error of 5.97 on the test data. This indicates that the *XGBRegressor* model can predict concrete compressive strength with a low error of less than 5% of the actual value.
...
This project has successfully modified to achieved its goal of predicting concrete compressive strength using machine learning models
